...
| `NEXT_PUBLIC_SITE_URL` | Public | **Yes** | `https://malik-seed-website.vercel.app` | Canonical public site URL for SEO metadata, dynamic open-graph images, and `sitemap.xml`. |
