  ...
  positions: [
    {
      ...
      fullDescription: "A R Malik Seeds is seeking a Senior Agronomist to lead multi-location crop performance trials and support the development of high-yield, climate-resilient varieties. This role plays a critical part in ensuring our seed products meet the highest standards of quality, adaptability, and farmer satisfaction.",
      whatYoullDo: [
      ...
      benefitsList: [
        ...
        { text: "Professional development opportunities", icon: "rocket-01.svg" },
        { text: "Supportive and growth-oriented workplace", icon: "plant-03.svg" }
      ]
    },
    {
      id: 2,
      title: "Field Development Officer",
      description: "Ensure proper seed usage, field demonstrations, and crop performance monitoring.",
      tags: ["Onsite", "Full time", "Bogura"],
      ...
      fullDescription: "We are looking for a dedicated Field Development Officer to conduct field demonstrations, provide agronomic support to farmers, and establish strong relationships with key stakeholders in Bogura region. You will act as the direct link between our research team and the farming community, driving seed adoption and crop success.",
      whatYoullDo: [
    ...
    },
    {
      ...
      description: "Lead seed production programs ensuring quality, purity, and timely supply.",
      ...
      fullDescription: "The Seed Production Manager will oversee our seed multiplication program, managing contracted farmers and production facilities in Rangpur. You will ensure seed production meets strict genetic purity, physical quality, and volume targets, securing our supply chain.",
      whatYoullDo: [
    ...
    },
    {
      ...
      description: "Ensure seed testing, physical purity check, and germination evaluation meet standard protocols.",
      ...
      fullDescription: "A R Malik Seeds is seeking a detail-oriented Quality Control Officer to oversee seed testing, purity checks, and germination assays at our Rajshahi laboratory. You will ensure that every bag of seed reaching farmers complies with highest national and international standards.",
      whatYoullDo: [
    ...
    },
    {
      ...
      description: "Plan and coordinate product launch campaigns, dealer conferences, and brand promotions.",
      ...
      fullDescription: "We are looking for a creative and result-oriented Marketing Executive to join our team in Dhaka. You will design, coordinate, and execute marketing campaigns, brand activities, and digital content specifically tailored to the agricultural sector, dealers, and farmers of Bangladesh.",
      whatYoullDo: [
    ...
    },
    {
      ...
      description: "Manage warehousing, seasonal dispatch scheduling, and dealer network logistics.",
      tags: ["Onsite", "Full time", "Bogura"],
      ...
      jobType: "Full-time",
      experience: "Mid Level (3+ years)",
      fullDescription: "We are seeking a Supply Chain & Distribution Coordinator to oversee inventory, warehousing, and transportation of seeds from processing plants to our dealer network. Based in Bogura, you will ensure timely, cost-effective, and safe distribution of seeds to support seasonal planting schedules.",
      whatYoullDo: [
