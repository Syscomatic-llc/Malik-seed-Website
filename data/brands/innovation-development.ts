export const innovationDevelopmentData = {
  ...
  intro: {
    layout: "text-tags-stats" as const,
  ...
  split1: {
    badge: "WHAT WE DO",
    title: "Designing, funding, and delivering\nthe work that moves outcomes forward",
  ...
  cards: {
    ...
    cards: [
      ...
      {
        category: "Agricultural Value chain",
