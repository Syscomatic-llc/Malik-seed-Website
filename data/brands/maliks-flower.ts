    ...
    steps: [
      {
        ...
        description: "We source from the world’s leading breeders evaluating for germination rate, color, stem strength, and local climate adaptability.",
      },
      {
        tag: "Technical support",
        title: "On-site floriculture support",
        description: "Our team offers practical field-level guidance to flower growers, including planting schedules and crop care.",
      },
      {
        tag: "Post-harvest",
        title: "Developing post-harvest technologies",
        description: "We introduce advanced post-harvest solutions that reduce losses, extend flower freshness, and help grower prosperity.",
      },
    ],
  },
  grid: {
