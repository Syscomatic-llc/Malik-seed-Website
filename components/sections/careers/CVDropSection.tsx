  ...
  return (
    <section className="w-full bg-[#F2F7F1] pb-[100px] pt-12 lg:pb-[100px] lg:pt-0">
      <div className="mx-auto w-full max-w-[1030px] px-4 lg:px-0">
        <div
          className="relative w-full border border-[#E4E7EC] bg-[#0D1A14] py-16 px-4 md:py-16 md:px-15 rounded-[24px] lg:rounded-[32px]"
          style={{ minHeight: "415px" }}
        >
          <div className="mx-auto flex max-w-[910px] flex-col items-center gap-[40px]">
            {/* Title */}
            <h2
              className="text-center font-inter-tight text-[24px] font-medium leading-[29px] text-[#F2F7F1] md:text-[32px] md:leading-[38px] max-w-[650px]"
            >
