  ...
  return (
    ...
    <section className="w-full bg-[#F2F7F1] py-10 md:py-[100px]" id="careers">
      <div className="mx-auto max-w-[1440px] px-4 md:px-[100px]">
        ...
        <div className="group relative flex w-full flex-col items-center justify-between overflow-hidden rounded-[24px] bg-white xl:h-[490px] xl:flex-row xl:rounded-[32px]">
          {/* Left content — Figma: 403x301, left:60px, top:95px (Frame 2147229510) */}
          <div className="flex w-full shrink-0 flex-col items-start justify-between gap-[16px] px-6 py-10 xl:ml-[60px] xl:h-[301px] xl:w-[403px] xl:px-0 xl:py-0 xl:absolute xl:top-[95px] xl:left-[60px] xl:ml-0">
            ...
            <div className="flex h-full w-full flex-col items-start justify-between gap-[32px] xl:h-[252px]">
              {/* Title — Figma: 403x174 (Frame 2147229501) */}
              <div className="relative w-full xl:h-[174px]">
                <h2
                  className="text-brand-dark text-[32px] leading-[38px] font-medium xl:absolute xl:top-0 xl:left-0 xl:text-[48px] xl:leading-[58px]"
                  style={{
          ...
          <div className="relative ml-auto hidden h-[430px] w-full max-w-[690px] overflow-hidden rounded-[32px] bg-white xl:mr-[23px] xl:block xl:absolute xl:top-[30px] xl:left-[527px] xl:mr-0">
