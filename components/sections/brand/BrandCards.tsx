...
export default function BrandCards({
  ...
  return (
    <section className="w-full bg-[#F2F7F1] py-16 md:py-24 px-4 md:px-8 lg:px-[100px]">
      <div className="max-w-[1240px] mx-auto flex flex-col items-center gap-12 md:gap-14">
        {/* Header */}
        ...
        <div className={`grid grid-cols-1 ${gridCols} gap-5 md:gap-6`}>
          {cards.map((card, idx) => (
            ...
            >
                <div className="size-[40px] text-center flex items-center justify-center text-[16px] rounded-[10px] bg-[#A9E179] group-hover:scale-125 transition-transform duration-300" >
                  {idx+1}
                </div>
