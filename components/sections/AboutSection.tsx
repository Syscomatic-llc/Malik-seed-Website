            ...
            <div className="flex flex-col items-center gap-[24px]">
              ...
              <div className="flex flex-col items-center gap-[32px]">
                ...
                <p className="font-sans text-center text-[24px] font-medium leading-[36px] text-brand-dark">
                  <span>Malik Seeds is the pioneer of hybrid vegetable seeds in Bangladesh.</span>
                  <span className="text-[#0D1A1499]"> We introduce international seed varieties to Bangladeshi farmers. Our history goes back to 1969 when our founder, A. R. Malik launched &ldquo;Atlas-70&rdquo; Cabbage from Sakata Seed Corporation, based in Japan. Today, we are among the most trusted brands in the agriculture industry.</span>
                </p>
